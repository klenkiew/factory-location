...
class NullLogger(object):
    ...
    def next_iteration(self, iteration_count, best, best_score, evaluations):
...
class StatisticsLogger(NullLogger):
    """Logger outputting information to standard output."""
    ...
    def next_iteration(self, iteration_count, best, best_score, evaluations):
        self.stats.setdefault(evaluations, []).append(best_score)
